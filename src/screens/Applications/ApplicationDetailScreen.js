    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        <View
          style={[
            styles.statusBar,
            {backgroundColor: statusColor[app.status] || '#6c757d'},
          ]}>
        ...
        <InfoRow
          ...
          value={`$${Number(app.monthly_income || 0).toLocaleString()}`}
        />
        <InfoRow label="Occupants" value={app.number_of_occupants} />
        <InfoRow
          label="Pets"
          value={app.has_pets ? `Yes — ${app.pet_details}` : 'No'}
        />
        <InfoRow
          label="Move-in Date"
          value={
        ...
        <InfoRow
          ...
          value={app.desired_lease_duration?.replace('_', ' ')}
        />
