      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.row}>
          <View style={styles.halfInput}>
            ...
            <TextInput
              ...
              onChangeText={v => update('preferred_city', v)}
          ...
          <View style={styles.halfInput}>
            ...
            <TextInput
              style={styles.input}
              value={prefs.preferred_province}
              onChangeText={v => update('preferred_province', v)}
        ...
        <View style={styles.row}>
          <View style={styles.halfInput}>
            ...
            <TextInput
              style={styles.input}
              value={String(prefs.min_budget || '')}
              onChangeText={v => update('min_budget', v)}
          ...
          <View style={styles.halfInput}>
            ...
            <TextInput
              style={styles.input}
              value={String(prefs.max_budget || '')}
              onChangeText={v => update('max_budget', v)}
              keyboardType="numeric"
              placeholder="$5000"
            />
          </View>
        ...
        <View style={styles.row}>
          <View style={styles.halfInput}>
            ...
            <TextInput
              style={styles.input}
              value={String(prefs.min_bedrooms || '')}
              onChangeText={v => update('min_bedrooms', v)}
              keyboardType="numeric"
              placeholder="Any"
            />
          </View>
          <View style={styles.halfInput}>
            ...
            <TextInput
              style={styles.input}
              value={String(prefs.min_bathrooms || '')}
              onChangeText={v => update('min_bathrooms', v)}
              keyboardType="numeric"
              placeholder="Any"
            />
          </View>
