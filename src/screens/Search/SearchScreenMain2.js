...
import { BottomSheetScrollView, BottomSheetView, WINDOW_HEIGHT } from '@gorhom/bottom-sheet';
...
function SearchScreenMain2({ navigation, route }) {
  ...
  return (
    <Container containerStyle={{
      ...
      >
        <BottomSheetScrollView showsVerticalScrollIndicator={false}  style={styles.bottomSheetContent}>
