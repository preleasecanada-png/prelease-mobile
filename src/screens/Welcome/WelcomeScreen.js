...
const slides = [
  {
    ...
    text: 'Discover all the amazing features designed to enhance your experience and make things easier.',
  ...
  <View style={styles.stepperContainer}>
    {[...Array(total)].map((_, i) => (
      <View
        style={[
          styles.stepper,
          index == i ? {width: 20, backgroundColor: Colors.primary} : {},
        ]}
      />
    ))}
  </View>
...
function WelcomeScreen({navigation}) {
  ...
  const {dispatch: ndispatch, navigate} = navigation;
