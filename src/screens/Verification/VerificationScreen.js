    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View
          style={[
            styles.statusCard,
            {borderColor: isVerified ? '#198754' : '#ffc107'},
          ]}>
          <Icon
            name={isVerified ? 'check-circle' : 'alert-circle'}
            size={40}
            color={isVerified ? '#198754' : '#ffc107'}
          />
          ...
          <Text style={styles.statusSub}>
            {isVerified
              ...
              : 'Please submit documents to verify your identity.'}
          </Text>
        </View>
        ...
        <View style={styles.itemCard}>
          ...
          <View
            style={[
              styles.badge,
              {
                backgroundColor: status?.identity_verified
                  ? '#198754'
                  : '#ffc107',
              },
            ]}>
            <Text style={styles.badgeText}>
              {status?.identity_verified ? 'VERIFIED' : 'PENDING'}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.itemCard}>
          ...
          <View
            style={[
              styles.badge,
              {
                backgroundColor: status?.address_verified
                  ? '#198754'
                  : '#ffc107',
              },
            ]}>
            <Text style={styles.badgeText}>
              {status?.address_verified ? 'VERIFIED' : 'PENDING'}
            </Text>
          </View>
        </View>
