...
function ForgotPasswordScreen({ navigation }) {
  ...
  const renderHeaderImage = React.useCallback(() => {
    return (
      <View style={[{ alignItems: "center", marginTop: 30 }]}>
        <Image source={Images.ForgotPassword} resizeMode="contain"
          style={{ width: WINDOW_WIDTH * 0.50, height: WINDOW_HEIGHT * 0.3, aspectRatio: 16/16 }}
        />
      </View>
    )
  }, [])
  ...
  return (
    ...
    >
      ...
      <CommanText commanText="Enter Email" commanTextstyle={styles.labelStyle} />
      <TextInput
        defaultInput
      ...
      <CommanBtnScreen
        ...
        commanBtnStyle={[styles.signUpLogInBtn, { marginTop: 10 }, loading && { opacity: 0.7 }]}
