    ...
    <View style={styles.container}>
      ...
      <View style={styles.codeSection}>
        ...
        <Text style={styles.bonusHint}>
          Earn{' '}
          <Text style={styles.bonusPct}>{stats?.bonus_percentage || 5}%</Text>{' '}
          when your referral completes their first payment.
        </Text>
      </View>
      ...
      <View style={styles.statsRow}>
        ...
        <View style={styles.statBox}>
          <Text style={[styles.statValue, {color: '#198754'}]}>
            {stats?.completed || 0}
          </Text>
        ...
        <View style={styles.statBox}>
          <Text style={[styles.statValue, {color: '#ffc107'}]}>
            {stats?.pending_referrals || stats?.registered || 0}
          </Text>
          <Text style={styles.statLabel}>Pending</Text>
        </View>
        <View style={styles.statBox}>
          <Text style={[styles.statValue, {color: '#D80621'}]}>
            ${Number(stats?.total_earned || 0).toFixed(0)}
          </Text>
              ...
              <View style={styles.row}>
                ...
                {item.remuneration_paid ? (
                  <Text style={styles.reward}>
                    +${Number(item.remuneration_amount || 0).toFixed(2)}
                  </Text>
                ) : null}
              </View>
            </View>
